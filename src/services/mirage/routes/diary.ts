...
//Next, let’s add some methods for working with Create diary:
...
export const addEntry = (schema: any, req: Request): { diary: Diary, entry: Entry } | Response => {
    try {
        ...
        return handleErrors(null, 'Failed to save entry.')
    }
}
...
export const getEntries = (schema: any, req: Request): { entries: Entry[] } | Response => {
    try {
        ...
        return handleErrors(null, 'Failed to get Diary entries.')
    }
}
